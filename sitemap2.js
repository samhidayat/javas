/**
 * Blogger Tabbed Style Table of Content Widget by Sam Hidayat
 * Free for change but keep the original attribution.
 * URL: https://samhidayat.blogspot.com
 * TEMPLATES: &lt;div id="tabbed-toc"&gt;&lt;span class="loading"&gt;Loading...&lt;/span&gt;&lt;/div&gt;&lt;script type="text/javascript"&gt;var tabbedTOC = {blogUrl:"http://anda5.blogspot.com", containerId: "tabbed-toc", activeTab: 1};&lt;/script&gt;&lt;script type="text/javascript" src="js/tabbed-toc.js"&gt;&lt;/script&gt;
 */

var tabbedTOC_defaults = {
	blogUrl: "http://www.infoanda.in", // Blog URL
